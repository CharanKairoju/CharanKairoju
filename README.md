...
### MLOps / DevOps / Cloud
`Docker` `Docker Compose` `Kubernetes` `AWS (EC2, S3, IAM, RDS, Lambda, CloudFormation)` `CI/CD` `GitHub Actions` `Helm` `Terraform (basic)` `Linux` `NGINX` `Infrastructure as Code` `Model Serving` `MLflow` `Monitoring`

### Backend / Full-Stack
`FastAPI` `Flask` `Node.js` `Express.js` `REST APIs` `WebSockets` `JWT Authentication` `PostgreSQL` `MongoDB` `Redis` `Supabase` `Firebase` `GraphQL` `TypeScript` `React` `Vite` `Tailwind CSS` `Next.js`

### Cybersecurity
`Network Security` `OWASP Top 10` `Nmap` `Nessus` `Wireshark` `Burp Suite` `OWASP ZAP` `Metasploit` `Vulnerability Assessment` `Penetration Testing` `Threat Modeling`
...
| Google Vertex AI Prompt Design | Google Cloud | 2024 |
| NVIDIA Jetson Nano AI | NVIDIA | 2024 |
| AWS Solutions Architecture Job Simulation | Forage | 2024 |
| React JS Certification | — | 2024 |
| Data Visualization using Python | — | 2024 |
...
**B.Tech in Data Science** · Anurag University, Hyderabad · *Aug 2022 – Jul 2026 (Expected)*  
Relevant: ML, Deep Learning, Data Structures, Algorithms, DBMS, OS, Computer Networks, Cloud Computing, Software Engineering, Cybersecurity, Data Mining, Big Data Analytics
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=CharanKairoju&show_icons=true&theme=github_dark&include_all_commits=true&count_private=true&hide_border=true" alt="GitHub Stats" width="48%"/>
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=CharanKairoju&layout=compact&theme=github_dark&hide=html&hide_border=true" alt="Top Languages" width="48%"/>
</p>

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=CharanKairoju&theme=github_dark&hide_border=true" alt="GitHub Streak" width="60%"/>
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/CharanKairoju/CharanKairoju/output/github-contribution-grid-snake-dark.svg" alt="Contribution Snake" width="80%"/>
</p>
